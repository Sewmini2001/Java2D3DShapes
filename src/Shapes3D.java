...
public class Shapes3D extends JFrame {
    ...
    addButton = new JButton("Add Shape"); // create shapes
    resizeButton = new JButton("Resize Shape");  // Added resize shape
    ...
    buttonPanel.setLayout(new BoxLayout(buttonPanel, BoxLayout.Y_AXIS)); // Set vertical alignment
    ...
    buttonPanel.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1)); // Black border, 1-pixel width

    add(buttonPanel, BorderLayout.WEST); // Align the button panel to the left (vertical)
    ...
    abstract class Shape {
        ...
        public Shape(int x, int y) {
            ...
            defaultColor = Color.YELLOW; // Default color for one side
        }
