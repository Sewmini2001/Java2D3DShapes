...
public class Shapes2D extends JFrame {
  ...
  public Shapes2D() {
    ...
    changeColorButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        Color newColor = JColorChooser.showDialog(Shapes2D.this, "Select a New Color", currentColor);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    selectColorButton.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        currentColor = JColorChooser.showDialog(Shapes2D.this, "Select a Color", currentColor);
   ...
   JPanel controlPanel2 = new JPanel();
    ...
    // Add your buttons to controlPanel2
    controlPanel2.add(selectColorButton);
    controlPanel2.add(clearButton);
    controlPanel2.add(shapeSelector);
    controlPanel2.add(useGradientButton);
    controlPanel2.add(saveButton);

    // Create a filler component to push the buttons to the top-left corner
    controlPanel2.add(Box.createVerticalGlue());

    // Create controlPanel and add controlPanel2 and controlPanel to it
//    JPanel controlPanel = new JPanel();
    controlPanel.setLayout(new BorderLayout());
    controlPanel.add(controlPanel2, BorderLayout.WEST);

    // Create a split pane to separate the control panel from the drawing area
JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, controlPanel, canvas);
splitPane.setDividerLocation(160); // Adjust the divider location as needed

// Set the border for the split pane
Color borderColor = Color.RED; // You can change this to your desired color
Border border = BorderFactory.createMatteBorder(0, 0, 0, 1, borderColor); // Set border color for the right edge of the control panel
splitPane.setBorder(border);

// Create a matte border for the divider to set its color
Color dividerColor = Color.BLUE; // Change this to your desired divider color
int dividerSize = 1; // You can adjust the size
Border dividerBorder = BorderFactory.createMatteBorder(0, dividerSize, 0, dividerSize, dividerColor);
splitPane.setUI(new BasicSplitPaneUI() {
    public BasicSplitPaneDivider createDefaultDivider() {
        return new BasicSplitPaneDivider(this) {
            public void setBorder(Border b) {
                super.setBorder(dividerBorder);
            }
        };
    }
});
